...
class UpdateNewMessage extends JsonScheme {
  ...
  static UpdateNewMessage create({
    ...
    updateNewMessage_data_create_json
        .removeWhere((key, value) => value == null);
    UpdateNewMessage updateNewMessage_data_create =
        UpdateNewMessage(updateNewMessage_data_create_json);
